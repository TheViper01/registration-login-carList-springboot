package registrationlogincarlist.advSearch;
...
public class EmployeeSpecification implements Specification<Car> {
    ...
    private Join<Car, User> departmentJoin(Root<Car> root){
        return root.join("users");
